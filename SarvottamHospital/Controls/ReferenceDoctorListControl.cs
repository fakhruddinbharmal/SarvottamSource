...
{
    public partial class ReferenceDoctorListControl : ObjectListControl
    {
        public ReferenceDoctorListControl()
            : base()
        {
            InitializeComponent();
        ...
        private ReferenceDoctor GetSelectedEntityObject()
        {
            return GetSelectedEntity(this.dgvData) as ReferenceDoctor;
        }
        ...
        private ReferenceDoctor GetSelected()
        {
            return GetSelectedEntity(this.dgvData) as ReferenceDoctor;
        }
