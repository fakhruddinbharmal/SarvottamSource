...
{
    public partial class OPDTreatmentListControl : SarvottamHospital.Controls.ObjectListControl
    {
        public OPDTreatmentListControl() : base()
        {
            InitializeComponent();
        ...
        private OPDTreatment GetSelected()
        {
            return GetSelectedEntity(this.dgvData) as OPDTreatment;
        }
        ...
        private OPDTreatment GetSelectedEntityObject()
        {
            return GetSelectedEntity(this.dgvData) as OPDTreatment;
        }
        ...
        protected override void LoadListData()
        {
            ...
            {
                if (e.DisplayName == "OPD Treatment")
                {
